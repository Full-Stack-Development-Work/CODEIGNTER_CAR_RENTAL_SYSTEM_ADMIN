    ...
    <div class="card-body">
        <form action="<?php echo base_url() . 'admin/transaksi_add_act' ?>" method="post">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="kostumer" class="form-control" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10"><input type="date" class="form-control" name="tgl_pinjam" required></div>
                <?php echo form_error('tgl_pinjam'); ?>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Return Date</label>
                <div class="col-sm-10"><input type="date" class="form-control" name="tgl_kembali" required></div>
                <?php echo form_error('tgl_kembali'); ?>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Total Price</label>
                <div class="col-sm-10"><input type="number" class="form-control" name="harga" placeholder="3000" required></div>
                <?php echo form_error('harga'); ?>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Fine Per-Day</label>
                <div class="col-sm-10"><input type="number" class="form-control" name="denda" placeholder="500" required></div>
